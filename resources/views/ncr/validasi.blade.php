                        ...
                        <tr>
                            ...
                            <td>
                                <div class="custom-control custom-checkbox mb-5 d-flex justify-content-center">
                                    <input type="checkbox" class="custom-control-input" id="{{$validator->pivot->id}}-{{$nomor}}"
                                        onClick="validasi(this)" @if($validator->pivot->validated == 1) checked disabled @endif>
                                    <label class="custom-control-label" for="{{$validator->pivot->id}}-{{$nomor}}">Check this
