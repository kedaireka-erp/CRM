                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="nama_proyek" name="nama_proyek" readonly />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                <label>No NCR</label>
                                <input value="{{ $jumlah_ncr }}/NCR/AST/{{ Carbon\Carbon::now()->format('m') }}/{{ Carbon\Carbon::now()->year }}" class="form-control" type="string" id="nomor_ncr" name="nomor_ncr" readonly />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group" id="kontak">
                                ...
                                <div class="row mb-4" id="form_kontak">
                                    <div class="col">
                                        <select class="custom-select2 d-block w-100 form-control" id="Kontak" name="kontak_id[]">
                                            <option value="" selected hidden disabled>
                                                Pilih Validator
                                            </option>
                            ...
                            <div class="form-group" id="itemm">
                                ...
                                <div class="row mb-4">
                                    <div class="col" id="items">
                                        <select class="custom-select2 d-block w-100 form-control" id="item" name="item_id[]">
                                            <option value="" selected hidden disabled>
                                                Pilih Item
                                            </option>
                                        </select>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input value="{{ auth()->user()->name }}" class="form-control" type="string" id="pelapor" name="pelapor" readonly />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control-file form-control height-auto" type="file" id="bukti_kecacatan" name="bukti_kecacatan" />
