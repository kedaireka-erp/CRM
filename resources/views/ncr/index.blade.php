        ...
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30 ">
                <div class="pd-20 d-flex justify-content-between align-items-center">
                    ...
                    <div class="mr-2">
                        <a href="#" class="btn btn-warning fa-pull-right" data-toggle="modal" data-target="#Medium-modal" type="button">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="/ncr/report" method="post">
                                        ...
                                        <div class="modal-body" id="form_tanggal">
                                            <input class="form-control" name="tanggal" id="tanggal" placeholder="Select Month" type="month" oninput="pilihTanggal(this)">
                                        </div>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            @can('edit-ncr')
                                            <a class="dropdown-item" href="/ncr/{{ $ncr->id }}/edit"><i class="dw dw-edit2"></i>
                                                Edit</a>
                                            @endcan
                                            @endif
