                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Mitra</label>
                                <input class="form-control" value="{{ $ncr->nama_mitra }}" type="text" id="nama_mitra" name="nama_mitra" readonly />
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Nama Project</label>
                                <input class="form-control" value="{{ $ncr->nama_proyek }}" type="text" id="nama_proyek" name="nama_proyek" readonly />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                <label>No NCR</label>
                                <input class="form-control" type="string" id="nomor_ncr" name="nomor_ncr" value="{{ $ncr->nomor_ncr }}" readonly />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Tanggal</label>
                                <input value="{{ Carbon\Carbon::now()->toDateString() }}" class="form-control datetimepicker-range" type="date" id="tanggal_ncr" name="tanggal_ncr" readonly />
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>No FPPP</label>
                                <select onchange="inputFppp(this)" class="custom-select2 d-block w-100 form-control" id="nomor_fppp" name="nomor_fppp">
                                    @foreach ($fppp as $fp)
                                    <option value="{{ $fp['nomor_fppp'] }}" {{ $fp['nomor_fppp'] == $ncr->nomor_fppp ? 'selected' : '' }}>
                                        {{ $fp['nomor_fppp'] }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="row mb-4" id="form_item">
                                    <div class="col" id="items">
                                        <select class="custom-select2 d-block w-100 form-control" name="item_id[]">
                                            ...
                                            <option value="{{ $item['kode_item'] . '-' . $item['nama_item'] }}" {{ $item['kode_item'] == $ncr->ItemNcr[0]->kode_item ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input value="{{ $ncr->pelapor }}" class="form-control" type="string" id="pelapor" name="pelapor" readonly />
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-12">
                            <div class="form-group">
                                <label>Jenis Ketidaksesuaian</label>
                                <input class="form-control" type="string" id="#" name="jenis_ketidaksesuaian" value="{{ $ncr->jenis_ketidaksesuaian }}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control-file form-control height-auto" value="" type="file" id="bukti_kecacatan" name="bukti_kecacatan" />
