    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        ...
        <form action="/memo/{{$ncr->id}}" method="post">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <button class="btn btn-primary" type="button" onClick="Proses()">Process</button>
            </div>
...
<script>
    ...
    function tambahForm(elemen) {
        ...
        for (let i = (jumlah - 1) * 10; i < input.length; i++) {
            if (input[i].name == "item_id[]" || input[i].name == "warna[]" || input[i].name == "bukaan[]" || input[i].name == "charge[]" || input[i].name == "return[]") {
