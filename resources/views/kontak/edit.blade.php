                ...
                <div class="pd-20 card-box mb-30">
                    <form action="/kontak/{$kontak->id}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ $kontak->nomor_whatsapp }}" type="text" class="form-control" name="nomor_whatsapp" required placeholder="08888....">
                        </div>
                        <div class="form-group">
                            <label>Divisi</label>
                            <input value="{{ $kontak->divisi }}" type="text" class="form-control" name="divisi" placeholder="Manajer">
